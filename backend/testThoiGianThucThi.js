...
const logToCSV = (filename, data, apiName) => {
  ...
  const content = data
    .map((row) => `${apiName},${row.requestNumber},${row.email},${row.responseTime},${row.status}`)
    .join('\n');
  ...
  try {
    const submitRes = await axios.post(
      `${BASE_URL}/result/submit`,
      {
        resultId,
        answers: [
          { questionId: '67f8d5cdbbf80c0887a65da2', selectedAnswerId: '67f8d5cdbbf80c0887a65da5', questionType: '6742fb1cd56a2e75dbd817ea' },
          { questionId: '67f8d5cdbbf80c0887a65dca', selectedAnswerId: '67f8d5cdbbf80c0887a65dcd', questionType: '6742fb1cd56a2e75dbd817ea' },
          { questionId: '67f8d5cdbbf80c0887a65db6', selectedAnswerId: '67f8d5cdbbf80c0887a65dba', questionType: '6742fb1cd56a2e75dbd817ea' },
          { questionId: '67f8d5cdbbf80c0887a65dc5', selectedAnswerId: '67f8d5cdbbf80c0887a65dc6', questionType: '6742fb1cd56a2e75dbd817ea' },
          { questionId: '67f8d5cdbbf80c0887a65da7', selectedAnswerId: '67f8d5cdbbf80c0887a65da9', questionType: '6742fb1cd56a2e75dbd817ea' },
        ],
        listeningAnswers: [],
        unansweredQuestions: [],
